...
public class ApiTask {
    ...
    public ApiTask() {
        Retrofit retrofit = TruckApp.getRetrofitInstance();
...
//    }
    ...
    public Call<?> getAllImei(String email, String password, String device_token, APICallback onApiCallback) {
        Call<ImeiListResp> call = apiCall.getAllImei();
        call.enqueue(onApiCallback);
        return call;
    }
